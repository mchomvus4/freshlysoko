	  ...
	  <div class="container-full">
			...
			<div class="col-8">
			 ...
			 <div class="box">
				<div class="box-header with-border">
				  <h3 class="box-title">All Brands List  <span class="badge badge-pill badge-success">{{count($brands)}}</span></h3>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
       ...
       @foreach ($brands as $item )
        <tr>
								...
								<td>
         <img src="{{asset($item->brand_image)}}" style="width: 70px; height: 40px;" alt="No Image">
         </td>
								<td>
   ...
   {{-- ----------------Add Brands----------------- --}}
      ...
      @csrf
         ...
         @enderror
							...
							<div class="form-group">
								<h5>Brand Name Swahili<span class="text-danger">*</span></h5>
								<div class="controls">
