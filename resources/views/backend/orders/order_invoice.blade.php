  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
          ...
          <h2 style="color: green; font-size: 26px;"><strong>Freshly Soko Online</strong></h2>
        </td>
        <td align="right">
            <pre class="font" >
               Freshly Soko Head Office
               Email:info@freshlysoko.co.tz <br>
               Mob: +(255) 767-298 555 <br>
               Mnazi Mmoja, P.O.Box 22222 <br>
