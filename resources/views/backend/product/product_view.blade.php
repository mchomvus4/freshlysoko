            ...
            <div class="col-12">
               ...
               <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Product List <span class="badge badge-pill badge-success">{{count($products)}}</span></h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                          ...
                          <tbody>
                           @foreach ($products as $item )
                                 ...
                                 <td> 
                                  ...
                                  @else
                                      @php
                                        $markedPrice = $item->selling_price + $item->discount_price;
                                        $discountPercent = ($item->discount_price/$markedPrice)*100;
                                      @endphp
                                       <span class="badge badge-pill badge-danger">{{round($discountPercent)}}%</span>
                                  @endif
