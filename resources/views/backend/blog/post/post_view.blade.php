						...
						<div class="col-12">						
								...
								<div class="controls">
									...
									@error('post_title_en')
										...
										<div class="col-md-6"><!--col-md 6-->
															<div class="form-group">
								<h5>Post Title Swahili <span class="text-danger">*</span></h5>
								<div class="controls">
									<input type="text" name="post_title_sw" class="form-control">
									@error('post_title_sw')
										<span class="text-danger">{{$message}}</span>
										@enderror
								</div>
...
<div class="row"> <!--start 8th row-->
								...
								<div class="col-md-6"><!--col-md 6-->
										<div class="form-group">
														<h5>Post Details Swahili<span class="text-danger">*</span></h5>
														<div class="controls">
															<textarea id="editor2" name="post_detail_sw" rows="10" cols="80">
												      Post Details  Swahili
						</textarea>
														</div>
													</div>
										</div><!--end col-md 6-->
