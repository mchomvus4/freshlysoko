    ...
    <article class="card">
        ...
        <div class="card-body">
           <div class="row" style="margin-left: 30px; margin-top:20px;">
            ...
            <div class="track"><!-- start tracking-->
                 ...
                 @elseif ($track->status == 'confirm')<!-- start confirm-->
                  <div class="step active"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text">Order Pending</span> </div>
                  ...
                  @elseif ($track->status == 'processing')<!-- start processing-->
                  ...
                  <div class="step active"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text"> Order Confirmed</span> </div>
                   ...
                   @elseif ($track->status == 'picked')<!-- start picked-->
                   <div class="step active"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text">Order Pending</span> </div>
                  ...
                  <div class="step active"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text"> Order Confirmed</span> </div>
                   ...
                   @elseif ($track->status == 'shipped')<!-- start shipped-->
                   <div class="step active"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text">Order Pending</span> </div>
                  ...
                  <div class="step active"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text"> Order Confirmed</span> </div>
                   ...
                   <div class="step active"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text"> Order Proccessing </span> </div>
                    ...
                    <div class="step "> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text">Order Delivered</span> </div>
                      ...
                      @elseif ($track->status == 'delivered')<!-- start delivered-->
