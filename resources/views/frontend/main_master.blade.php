          ...
          <div class="row">
            ...
            <div class="col-md-4">
             ...
             <div class="form-group" id="sizeArea">
              <label for="size">Choose Weight</label>
        ...
        function productView(id){
          ...
          $.ajax({
            ...
            success:function(data){
              ...
              $('#product_id').val(id);//for AddToCart method
              $('#qty').val();
                ...
                if (data.product.discount_price == null) {
                        $('#pdprice').text('');
                        $('#oldprice').text('');
                        $('#pdprice').text(data.product.selling_price);
                }else{
                      $('#pdprice').text(data.product.discount_price);
          ...
          if (data.total) {
            ...
            $('#couponCalField').html(
              `<tr>
                                    <th>
                                       <div class="cart-sub-total">
                                          Subtotal<span class="inner-left-md">${data.subtotal}Tshs.</span>
                                       </div>

                                       <div class="cart-sub-total">
                                          Coupon<span class="inner-left-md">${data.coupon_name}Tshs.</span>
                                          <button type="submit" onclick="couponRemove()"><i class="fa fa-times"></i></button> 
                                       </div>

                                       <div class="cart-sub-total">
                                          Discount Amount<span class="inner-left-md">${data.discount_amount}Tshs.</span>
                                       </div>

                                       <div class="cart-grand-total">
                                          Grand Total<span class="inner-left-md">${data.total_amount}Tshs.</span>
                                       </div>
                                    </th>
                                 </tr>`
            )
...
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-623327a77a848a1e"></script>
</body>
</html>