    ...
    <div class="body-content">
        <div class="container">
            <div class="row">
               ...
               <table class="table">
                <tbody>
                 ...
                 @foreach ($orderItem as $item )
                  <tr>
                   <td class="col-md-1">
                    <label for=""><img src="{{asset($item->product->product_thambnail)}}" width="50px;" height="50px;"></label>
                   </td>
                   <td class="col-md-3">
              ...
              <button type="submit" class="btn btn-danger">Retun Order</button>
              </form>
              @else
              <span class="badge badge-pill badge-danger" style="background: red;">You have sent return request for this product</span>
              @endif
