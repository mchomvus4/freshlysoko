	...
	<section class="content">
      ...
      @csrf
       ...
       <div class="row">
         ...
         <div class="col-md-6">
          <img id="showImage" src="{{(!empty($adminData->profile_photo_path))?url('upload/admin_images/.$editData->profile_photo_path'):url('upload/no_image.jpg')}}" alt="" style="width: 100px; height:100px;">
         </div><!-- end col md-6-->
