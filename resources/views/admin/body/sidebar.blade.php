      ...
      <ul class="sidebar-menu" data-widget="tree">  
        ...
        <li class="treeview {{($prefix == '/brand' ) ? 'active' : ''}}">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{($route == 'all.brand') ? 'active' : ''}}"><a href="{{route('all.brand')}}"><i class="ti-more"></i>All Partners</a></li>
        ...
        <li class="treeview {{($prefix == '/category' ) ? 'active' : ''}}">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{($route == 'all.sub_subcategory') ? 'active' : ''}}" ><a href="{{route('all.sub_subcategory')}}"><i class="ti-more"></i>All Sub->Sub Category</a></li>
        ...
        <li class="header nav-small-cap">User Interface</li>
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{($route == 'comfirmed-orders') ? 'active' : ''}}" ><a href="{{route('comfirmed-orders')}}"><i class="ti-more"></i>Comfirmed Orders</a></li>
